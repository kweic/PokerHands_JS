...
PokerHand.prototype.compareWith = function(hand){
    return this.handComparison(hand.myHand);
}
...
this.handComparison = function(secondHand) {
    var sortedFirstHand, sortedSecondHand, firstRank, secondRank;

    sortedFirstHand = sortHand(this.myHand);
    ...
    if (firstRank > secondRank) {
        ...
        var tie = tieBreak(sortedFirstHand, sortedSecondHand, firstRank);
        return tie;
    }
}
